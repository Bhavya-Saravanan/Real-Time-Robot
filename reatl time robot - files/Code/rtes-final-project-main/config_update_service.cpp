 ...
 * Description: File contains macros,global and function definitions related to config update service
 * Author: Nalin Saxena
 ***************************************************************/
#include "config_update_service.hpp"

// fetch new config from file
...
/*
keeps track of last modified timestamp, if file modified calls load_config
to get new values
*/
